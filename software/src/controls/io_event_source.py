...
class IOEventSource:
    def __init__(self, title, pin_number, pin_mode, pin_pull, long_hold_threshold=750, tapped_threshold=300, invert=False, on_event=None, on_tapped=None, on_active=None, on_deactive=None, on_hold=None, on_long_hold=None):
        self.title = title
    ...
    def tick(self):
        state = False
        state = self.pin.value() if not self.invert else not self.pin.value()
